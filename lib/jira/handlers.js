...
async function handleJiraCreate(opts) {
  let fileOptions = {};
...
async function handleJiraSearch(opts) {
  const client = createJiraClient();
...
async function handleJiraUpdate(issueIdOrKey, opts) {
  let fileOptions = {};
...
async function handleJiraGet(issueIdOrKey, opts) {
